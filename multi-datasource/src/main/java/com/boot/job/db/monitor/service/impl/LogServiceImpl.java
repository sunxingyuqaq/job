package com.boot.job.db.monitor.service.impl;
...
import com.boot.job.db.common.utils.AddressUtil;
import com.boot.job.db.common.utils.SortUtil;
import com.boot.job.db.monitor.entity.Log;
import com.boot.job.db.monitor.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements ILogService {
    ...
    public void saveLog(ProceedingJoinPoint point, Log log) throws JsonProcessingException {
        ...
        com.boot.job.db.common.annotation.Log logAnnotation = method.getAnnotation(com.boot.job.db.common.annotation.Log.class);
