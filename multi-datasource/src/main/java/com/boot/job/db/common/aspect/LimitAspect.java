...
import com.boot.job.db.common.entity.LimitType;
import com.boot.job.db.common.exception.LimitAccessException;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.boot.job.db.common.annotation.Limit)")
